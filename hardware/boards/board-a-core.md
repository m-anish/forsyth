...
| Q1 | **AO3407** — subs: **SI2307(DS)/CJ2307** / **IRLML9301** (2026-07-13, stock) | SOT-23 | reverse-pol (solar input) — needs **±20 V V_GS** to survive the TVS clamp; both subs verified ±20 V, −30 V V_DS, same G-S-D pinout ([SI2307](https://www.mccsemi.com/pdf/Products/SI2307(SOT-23).pdf), [IRLML9301](https://www.infineon.com/dgdl/Infineon-IRLML9301-DataSheet-v01_01-EN.pdf?fileId=5546d462533600a401535668e5e42640)). AO3407A clones also fine — **CJ3407 verified ±20 V** ([datasheet](https://xdf-1305158653.cos.ap-guangzhou.myqcloud.com/1663395720-6681.pdf); Evelta/Quartz stock), HXY/WST/UMW likewise; check top marking reads 3407 on delivery. **AO3401 only with a gate clamp** (10 V zener S→G + 100 k G→GND) — its ±12 V gate is otherwise exceeded here |
| Q2 | **AO3407** — same subs as Q1; here even **AO3401 drops in unmodified** (DRV clamps gate drive ≤ 8 V) | SOT-23 | buck pass P-FET — datasheet-suggested "3407A" |
