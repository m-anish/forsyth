...
| A5L | **Boost inductor: Sunlord SWPA5040S1R0NT ×2** (1 µH shielded wirewound, 5.0×5.0×4.0 mm, I_sat ≈ 5.5 A, DCR ≈ 18 mΩ) | one per boost stage | selected 2026-07-13 | ~₹10–30 ea | **Preferred:** shielded (no flux spray toward vane ADC/antenna), I_sat clears the TPS61023's ~3.7 A current-limit corner. Substitutes in order: Murata DFE201610E-1R0M (metal alloy, soft-sat, 57 mΩ); CD54/CD43 drum `1R0` (unshielded — placement zones already account for it). **Rejected:** LQM2HP multilayer (2.1 A = L collapse at the T30D burst peak); radial through-hole (plane punctures + height for no gain) |
