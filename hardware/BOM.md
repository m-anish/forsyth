...
| 6 | **TPS22918-class load switch** ×2 (or P-MOSFET + driver) | Power gates: E22 rail, PMS7003 rail | LCSC/JLCPCB practical; Mouser India awkward for individuals | 30–80 ea | Non-negotiable per architecture §3.1; one dedicated GPIO each |
| 7 | **5 V boost converter** ×2 (module or IC stage) | E22 rail, PMS7003 rail | any basic boost, Robu etc. | 30–80 ea | Both gated, both off between uses. E22's boost must source ≥1.3 A burst if T30D is fitted |
...
| 14 | **Bulk caps**: 100–220 µF low-ESR ×2 + ceramics | Post-gate rail support (E22, PMS7003) | any | <100 | **Downstream of the load switches** — the component lokki's Rev0 lacked |
...
- **LCSC + JLCPCB assembly** remains the practical route for load switches and any part
  awkward to buy retail in India (JLCPCB places them as part of a PCBA order; no B2B
  Mouser account needed).
